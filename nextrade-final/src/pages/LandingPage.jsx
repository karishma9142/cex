...
function TickerBar() {
  ...
  return (
    <div className="bg-bg2 border-t border-b border-border py-2.5 overflow-hidden">
      <div className="flex gap-12 whitespace-nowrap w-max
  ...
  return (
    <div className="bg-bg border border-border2 rounded-xl overflow-hidden shadow-2xl">
      ...
      <div className="flex flex-wrap items-center gap-3 px-4 py-3
        ...
        <span className="font-mono text-xs text-green bg-green/10 px-2 py-0.5 rounded">
          ▲ +2.41%
        </span>
      ...
      <div className="grid grid-cols-[1fr_150px] h-[220px]">
        ...
        <div className="border-l border-border p-2.5 overflow-hidden">
          <div className="grid grid-cols-2 text-[10px] text-ink3 uppercase
            tracking-wide mb-1.5 pb-1.5 border-b border-border">
            <span>Price</span>
          ...
          <div className="text-center text-[10px] text-ink3 font-mono
            py-1 border-y border-border my-1">
            Spread ₹400
          </div>
    ...
    <div className="min-h-screen bg-bg text-ink font-body">
      ...
      <section className="relative min-h-screen flex flex-col items-center
        ...
        <div className="animate-fade-up flex items-center gap-2
          bg-bg3 border border-border2 px-3.5 py-1.5 rounded-full
          font-mono text-xs text-blue mb-7">
        ...
        <div className="animate-fade-up-5 flex divide-x divide-border
          ...
          {[
            ...
            <div key={s.l} className="px-6 md:px-8 py-4 text-left">
              <p className="font-mono text-[22px] font-medium text-ink leading-none mb-1">
                {s.n}
              </p>
      ...
      <section id="features" className="py-24 px-6 max-w-[1180px] mx-auto">
        ...
        <Reveal delay={100}>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-px
            ...
            {FEATURES.map((f, i) => (
              <div key={i}
                className="bg-bg2 hover:bg-bg3 p-8 transition-colors duration-200">
      ...
      <section className="bg-bg2 border-t border-b border-border py-20 px-6">
        <div className="max-w-[1180px] mx-auto grid grid-cols-1 lg:grid-cols-2
          gap-16 items-center">
            ...
            <div className="flex flex-col gap-6">
              {[
                ...
                <div key={p.n} className="flex gap-4">
                  ...
                  <div>
                    <p className="font-display font-semibold text-[15px] mb-1 tracking-tight">
                      {p.t}
                    </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-14">
            {STEPS.map((s, i) => (
              <div key={i}
                ...
                <p className="font-display font-semibold text-[15px] mb-2 tracking-tight">
                  {s.title}
                </p>
      ...
      {/* ═══════════════════════════ MARKETS TABLE ════════════════════════════ */}
      <section id="markets"
        className="bg-bg2 border-t border-b border-border py-20 px-6">
                ...
                <thead>
                  <tr className="bg-bg3 border-b border-border">
                    {['Pair','Last price','24h change','24h high','24h low','Volume',''].map(h => (
                      <th key={h}
                        className="text-left px-4 py-3 text-[11px] font-mono
                    ...
                    <tr key={i}
                      ...
                      <td className="px-4 py-4">
                        <span className={`inline-flex items-center font-mono text-xs
                          ...
                          ${m.up ? 'text-green bg-green/10' : 'text-red bg-red/10'}`}>
                          {m.chg}
                        </span>
                      </td>
      ...
      <section className="relative py-28 px-6 text-center overflow-hidden">
        ...
        <Reveal>
          ...
          <p className="text-[16px] text-ink2 mb-12 font-light max-w-md mx-auto leading-relaxed">
            Join NexTrade and experience professional-grade crypto trading
            on a real matching engine.
          </p>
      ...
      <footer className="border-t border-border bg-bg2 px-6 md:px-14 py-8
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="font-display text-sm font-bold text-ink2 tracking-tight">
            NexTrade
          </span>
        </div>
